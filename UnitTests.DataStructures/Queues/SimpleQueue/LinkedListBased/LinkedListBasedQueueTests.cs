...
using System.Linq;
using DSA = DataStructures.Queues.SimpleQueue.LinkedListBased;

namespace UnitTests.DataStructures.Queues.SimpleQueue.LinkedListBased
{
    [TestClass]
    public class LinkedListBasedQueueTests
    {
        ...
        public LinkedListBasedQueueTests()
        {
            ...
            intQueue = new DSA.Queue<int>();
            stringQueue = new DSA.Queue<string>();
        }
