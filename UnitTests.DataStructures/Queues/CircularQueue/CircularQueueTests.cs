...
namespace UnitTests.DataStructures.Queues.CircularQueue
{
    [TestClass]
    public class CircularQueueTests
    {
        ...
        private CircularQueue<int> intQueue;
        ...
        public CircularQueueTests()
        {
            ...
            intQueue = new CircularQueue<int>();
            stringQueue = new CircularQueue<string>();
        }
