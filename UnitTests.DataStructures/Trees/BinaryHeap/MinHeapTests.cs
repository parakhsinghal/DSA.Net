...
namespace UnitTests.DataStructures.Trees.BinaryHeap
{
    ...
    public  class MinHeapTests
    {
        ...
        MinHeap<int> intHeap;
        MinHeap<int> negativeIntHeap;
        MinHeap<uint> uintHeap;
        ...
        public MinHeapTests()
        {
            ...
            maxHeapSection = configuration.GetSection("MinHeap");
            ...
            intHeap = new MinHeap<int>();
            negativeIntHeap = new MinHeap<int>();
            uintHeap = new MinHeap<uint>();
            charHeap = new MinHeap<char>();
