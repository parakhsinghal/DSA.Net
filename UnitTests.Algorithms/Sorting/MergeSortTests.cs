...
namespace UnitTests.Algorithms.Sorting
{
    ...
    public class MergeSortTests
    {
        ...
        private MergeSort<int> intSort;
        private MergeSort<char> charSort;
        private MergeSort<string> stringSort;
        ...
        public void InitializeLocalFields()
        {
            ...
            intSort = new MergeSort<int>();
            charSort = new MergeSort<char>();
            stringSort = new MergeSort<string>();
        }
