...
namespace UnitTests.Algorithms.Sorting
{
    ...
    public class InsertionSortTests
    {
        ...
        private InsertionSort<int> intSort;
        private InsertionSort<char> charSort;
        private InsertionSort<string> stringSort;
        ...
        public void InitializeLocalFields()
        {
            ...
            intSort = new InsertionSort<int>();
            charSort = new InsertionSort<char>();
            stringSort = new InsertionSort<string>();
        }
